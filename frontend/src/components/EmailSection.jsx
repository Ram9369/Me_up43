  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-6">
        ...
        <h5 className="text-3xl mt-7 font-bold text-white">Let's Build Something Amazing</h5>
        ...
        <div className="grid gap-8 sm:grid-cols-2 ">
          ...
          <div className="rounded-2xl flex flex-col border border-white/10 bg-white/5 p-6 transition hover:border-blue-500/40 hover:shadow-[0_0_20px_rgba(56,189,248,0.3)]">
            ...
            <a
              ...
              className="mt-1 inline-flex items-center gap-2 text-white transition hover:text-purple-300"
            >
              <FaGithub className="h-5 w-5 text-white justify-center rounded-full border border-white/10 bg-white/5" />
          ...
          <div className="rounded-2xl  border w-50% border-white/10 bg-white/5 p-6 transition hover:border-blue-500/40 hover:shadow-[0_0_20px_rgba(56,189,248,0.3)]">
            ...
            <a
              ...
              className="mt-1 inline-flex items-center gap-2 text-white transition hover:text-purple-300"
            >
              <FaLinkedin className="h-5 w-5 text-white justify-center rounded-full border border-white/10 bg-white/5" />
              Ram Pratap
            </a>
          </div>
      ...
      {/* Form */}
      <div className="relative rounded-[2rem] transition hover:border-blue-500/40 hover:shadow-[0_0_20px_rgba(56,189,248,0.3)]">
        <form
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 px-5 py-3 font-semibold text-white transition hover:scale-[1.01] disabled:opacity-70"
          >
